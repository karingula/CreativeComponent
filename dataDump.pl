...
# Purpose: Dump spreadsheets from Excel file to tab-seperated text files while unicode
#          characters are appropriately coded
#
...
############################################################################################
  ...
  my $warn = <<EOS
    ...
    $0 [options] <spreadsheetname> <output-dir>
